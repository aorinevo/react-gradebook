...
const AddAssignmentForm = ({ handleSubmit, pristine, reset, submitting, gbid }: {handleSubmit?: any, pristine?: any, reset?: any, submitting?: any, gbid?: number}) => {
  return (
    <form onSubmit={handleSubmit} className="form-horizontal">
      ...
      <Field type="hidden" component="text" name="gbid" value={gbid}/>
      <div>
        Add to course {gbid}?            			
      </div>
      <div>
        <Link to={`/gradebook/${gbid}`} className="btn btn-default">Close</Link>
        <Link to={`/gradebook/${gbid}`} className="btn btn-primary">Save</Link>
      </div>
    </form>
  );
};
